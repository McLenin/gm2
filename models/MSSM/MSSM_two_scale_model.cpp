...
void CLASSNAME::calculate_pole_masses()
{
   ...
   std::thread thread_MGlu(Thread(this, &CLASSNAME::calculate_MGlu_pole_1loop));
   std::thread thread_MSd(Thread(this, &CLASSNAME::calculate_MSd_pole_1loop));
   std::thread thread_MSv(Thread(this, &CLASSNAME::calculate_MSv_pole_1loop));
   std::thread thread_MSu(Thread(this, &CLASSNAME::calculate_MSu_pole_1loop));
   std::thread thread_MSe(Thread(this, &CLASSNAME::calculate_MSe_pole_1loop));
   std::thread thread_Mhh(Thread(this, &CLASSNAME::calculate_Mhh_pole_1loop));
   std::thread thread_MAh(Thread(this, &CLASSNAME::calculate_MAh_pole_1loop));
   std::thread thread_MHpm(Thread(this, &CLASSNAME::calculate_MHpm_pole_1loop));
   std::thread thread_MChi(Thread(this, &CLASSNAME::calculate_MChi_pole_1loop));
   std::thread thread_MCha(Thread(this, &CLASSNAME::calculate_MCha_pole_1loop));

   if (calculate_sm_pole_masses) {
      std::thread thread_MFd(Thread(this, &CLASSNAME::calculate_MFd_pole_1loop));
      std::thread thread_MFe(Thread(this, &CLASSNAME::calculate_MFe_pole_1loop));
      std::thread thread_MFu(Thread(this, &CLASSNAME::calculate_MFu_pole_1loop));
      std::thread thread_MFv(Thread(this, &CLASSNAME::calculate_MFv_pole_1loop));
      std::thread thread_MVG(Thread(this, &CLASSNAME::calculate_MVG_pole_1loop));
      std::thread thread_MVP(Thread(this, &CLASSNAME::calculate_MVP_pole_1loop));
      std::thread thread_MVWm(Thread(this, &CLASSNAME::calculate_MVWm_pole_1loop));
      std::thread thread_MVZ(Thread(this, &CLASSNAME::calculate_MVZ_pole_1loop));
      thread_MFd.join();
      thread_MFe.join();
      thread_MFu.join();
      thread_MFv.join();
...
double CLASSNAME::get_ewsb_eq_vd() const
{
   double ewsb_eq_vd = mHd2*vd + vd*AbsSqr(Mu) - 0.5*vu*BMu - 0.5*vu*Conj(BMu)
...
double CLASSNAME::get_ewsb_eq_vu() const
{
   double ewsb_eq_vu = mHu2*vu + vu*AbsSqr(Mu) - 0.5*vd*BMu - 0.5*vd*Conj(BMu)
...
std::complex<double> CLASSNAME::CpconjUSdSdAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_218 += tmp_219;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_218;
   if (gO2 < 3) {
      ...
      tmp_222 += tmp_223;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_222;
   }
   ...
   tmp_224 += tmp_225;
   result += (Complex(0.,-0.7071067811865475)*Conj(Mu)*ZA(gI2,1)) * tmp_224;
   if (gO2 < 3) {
      ...
      tmp_228 += tmp_229;
      result += (Complex(0.,0.7071067811865475)*Mu*ZA(gI2,1)) * tmp_228;
   }
...
std::complex<double> CLASSNAME::CpUSvconjUSvconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_307 += tmp_308;
   tmp_306 += (Complex(0,0.05)*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_307;
   ...
   tmp_309 += tmp_310;
   tmp_306 += (Complex(0,0.25)*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_309;
   ...
   tmp_311 += tmp_312;
   tmp_306 += (Complex(0,0.1)*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_311;
   result += (Complex(0,-1)) * tmp_306;
...
std::complex<double> CLASSNAME::CpUSvconjUSvconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_324 += tmp_325;
   tmp_323 += (Complex(0,0.05)*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_324;
   ...
   tmp_326 += tmp_327;
   tmp_323 += (Complex(0,-0.25)*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_326;
   ...
   tmp_328 += tmp_329;
   tmp_323 += (Complex(0,-0.2)*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_328;
   result += (Complex(0,-1)) * tmp_323;
...
std::complex<double> CLASSNAME::CpconjUSuSuAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_568 += tmp_569;
   result += (Complex(0.,-0.7071067811865475)*Conj(Mu)*ZA(gI2,0)) * tmp_568;
   if (gO2 < 3) {
      ...
      tmp_572 += tmp_573;
      result += (Complex(0.,0.7071067811865475)*Mu*ZA(gI2,0)) * tmp_572;
   }
   ...
   tmp_574 += tmp_575;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,1)) * tmp_574;
   if (gO2 < 3) {
      ...
      tmp_578 += tmp_579;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,1)) * tmp_578;
   }
...
std::complex<double> CLASSNAME::CpconjUSeSeAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_816 += tmp_817;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_816;
   if (gO2 < 3) {
      ...
      tmp_820 += tmp_821;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_820;
   }
   ...
   tmp_822 += tmp_823;
   result += (Complex(0.,-0.7071067811865475)*Conj(Mu)*ZA(gI2,1)) * tmp_822;
   if (gO2 < 3) {
      ...
      tmp_826 += tmp_827;
      result += (Complex(0.,0.7071067811865475)*Mu*ZA(gI2,1)) * tmp_826;
   }
...
std::complex<double> CLASSNAME::CpUhhUhhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_883 += tmp_884;
   tmp_882 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_883;
   ...
   tmp_885 += tmp_886;
   tmp_882 += (Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g2)) * tmp_885;
   ...
   tmp_887 += tmp_888;
   tmp_882 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_887;
   ...
   tmp_889 += tmp_890;
   tmp_882 += (Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g2)) * tmp_889;
   ...
   tmp_891 += tmp_892;
   tmp_882 += (Complex(0,0.1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_891;
   ...
   tmp_893 += tmp_894;
   tmp_882 += (Complex(0,-0.1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_893;
   ...
   tmp_895 += tmp_896;
   tmp_882 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_895;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_908 += tmp_909;
   tmp_907 += (Complex(0,-0.15)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_908;
   ...
   tmp_910 += tmp_911;
   tmp_907 += (Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g2)) * tmp_910;
   ...
   tmp_912 += tmp_913;
   tmp_907 += (Complex(0,0.15)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_912;
   ...
   tmp_914 += tmp_915;
   tmp_907 += (Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g2)) * tmp_914;
   ...
   tmp_916 += tmp_917;
   tmp_907 += (Complex(0,0.3)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_916;
   ...
   tmp_918 += tmp_919;
   tmp_907 += (Complex(0,-0.3)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_918;
   ...
   tmp_920 += tmp_921;
   tmp_907 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_920;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_933 += tmp_934;
   tmp_932 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_933;
   ...
   tmp_935 += tmp_936;
   tmp_932 += (Complex(0,-0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g2)) * tmp_935;
   ...
   tmp_937 += tmp_938;
   tmp_932 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_937;
   ...
   tmp_939 += tmp_940;
   tmp_932 += (Complex(0,0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g2)) * tmp_939;
   ...
   tmp_941 += tmp_942;
   tmp_932 += (Complex(0,-0.2)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_941;
   ...
   tmp_943 += tmp_944;
   tmp_932 += (Complex(0,0.2)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_943;
   ...
   tmp_945 += tmp_946;
   tmp_932 += (Complex(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)) *
      tmp_945;
...
std::complex<double> CLASSNAME::CpUhhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_958 += tmp_959;
   tmp_957 += (Complex(0,0.05)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_958;
   ...
   tmp_960 += tmp_961;
   tmp_957 += (Complex(0,0.25)*vd*KroneckerDelta(0,gO2)*Sqr(g2)) * tmp_960;
   ...
   tmp_962 += tmp_963;
   tmp_957 += (Complex(0,-0.05)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_962;
   ...
   tmp_964 += tmp_965;
   tmp_957 += (Complex(0,-0.25)*vu*KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_964;
   ...
   tmp_966 += tmp_967;
   tmp_957 += (Complex(0,0.1)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_966;
   ...
   tmp_968 += tmp_969;
   tmp_957 += (Complex(0,-0.1)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_968;
   ...
   tmp_970 += tmp_971;
   tmp_957 += (Complex(0.,0.7071067811865475)*Conj(Mu)*KroneckerDelta(1,gO2)) *
      tmp_970;
   ...
   tmp_974 += tmp_975;
   tmp_957 += (Complex(0.,-0.7071067811865475)*KroneckerDelta(0,gO2)) * tmp_974
      ;
   ...
   tmp_978 += tmp_979;
   tmp_957 += (Complex(0.,0.7071067811865475)*KroneckerDelta(1,gO2)*Mu) *
      tmp_978;
   ...
   tmp_982 += tmp_983;
   tmp_957 += (Complex(0.,-0.7071067811865475)*KroneckerDelta(0,gO2)) * tmp_982
      ;
   ...
   tmp_986 += tmp_987;
   tmp_957 += (Complex(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_986;
   ...
   tmp_992 += tmp_993;
   tmp_957 += (Complex(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_992;
   result += (Complex(0,-1)) * tmp_957;
...
std::complex<double> CLASSNAME::CpUhhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_999 += tmp_1000;
   tmp_998 += (Complex(0,-0.15)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_999;
   ...
   tmp_1001 += tmp_1002;
   tmp_998 += (Complex(0,0.25)*vd*KroneckerDelta(0,gO2)*Sqr(g2)) * tmp_1001;
   ...
   tmp_1003 += tmp_1004;
   tmp_998 += (Complex(0,0.15)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1003;
   ...
   tmp_1005 += tmp_1006;
   tmp_998 += (Complex(0,-0.25)*vu*KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1005;
   ...
   tmp_1007 += tmp_1008;
   tmp_998 += (Complex(0,0.3)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1007;
   ...
   tmp_1009 += tmp_1010;
   tmp_998 += (Complex(0,-0.3)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1009;
   ...
   tmp_1011 += tmp_1012;
   tmp_998 += (Complex(0.,0.7071067811865475)*Conj(Mu)*KroneckerDelta(1,gO2)) *
      tmp_1011;
   ...
   tmp_1015 += tmp_1016;
   tmp_998 += (Complex(0.,-0.7071067811865475)*KroneckerDelta(0,gO2)) *
      tmp_1015;
   ...
   tmp_1019 += tmp_1020;
   tmp_998 += (Complex(0.,0.7071067811865475)*KroneckerDelta(1,gO2)*Mu) *
      tmp_1019;
   ...
   tmp_1027 += tmp_1028;
   tmp_998 += (Complex(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1027;
   ...
   tmp_1033 += tmp_1034;
   tmp_998 += (Complex(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1033;
   result += (Complex(0,-1)) * tmp_998;
...
std::complex<double> CLASSNAME::CpUhhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1040 += tmp_1041;
   tmp_1039 += (Complex(0,0.05)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1040;
   ...
   tmp_1042 += tmp_1043;
   tmp_1039 += (Complex(0,-0.25)*vd*KroneckerDelta(0,gO2)*Sqr(g2)) * tmp_1042;
   ...
   tmp_1044 += tmp_1045;
   tmp_1039 += (Complex(0,-0.05)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1044;
   ...
   tmp_1046 += tmp_1047;
   tmp_1039 += (Complex(0,0.25)*vu*KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1046;
   ...
   tmp_1048 += tmp_1049;
   tmp_1039 += (Complex(0,-0.2)*vd*KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1048;
   ...
   tmp_1050 += tmp_1051;
   tmp_1039 += (Complex(0,0.2)*vu*KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1050;
   ...
   tmp_1052 += tmp_1053;
   tmp_1039 += (Complex(0.,0.7071067811865475)*Conj(Mu)*KroneckerDelta(0,gO2))
      * tmp_1052;
   ...
   tmp_1056 += tmp_1057;
   tmp_1039 += (Complex(0.,-0.7071067811865475)*KroneckerDelta(1,gO2)) *
      tmp_1056;
   ...
   tmp_1060 += tmp_1061;
   tmp_1039 += (Complex(0.,0.7071067811865475)*KroneckerDelta(0,gO2)*Mu) *
      tmp_1060;
   ...
   tmp_1068 += tmp_1069;
   tmp_1039 += (Complex(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1068;
   ...
   tmp_1074 += tmp_1075;
   tmp_1039 += (Complex(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1074;
   result += (Complex(0,-1)) * tmp_1039;
...
std::complex<double> CLASSNAME::CpUhhVZAh(unsigned gO2, unsigned gI2) const
{
   ...
   result = Complex(0,-0.1)*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(
      ThetaW()))*(KroneckerDelta(0,gO2)*ZA(gI2,0) - KroneckerDelta(1,gO2)*ZA(gI2,1
      ));
...
std::complex<double> CLASSNAME::CpUAhbargWmgWm(unsigned gO1) const
{
   ...
   result = Complex(0,-0.25)*(vd*KroneckerDelta(0,gO1) - vu*KroneckerDelta(1,
      gO1))*Sqr(g2);
...
std::complex<double> CLASSNAME::CpUAhbargWmCgWmC(unsigned gO1) const
{
   ...
   result = Complex(0,0.25)*(vd*KroneckerDelta(0,gO1) - vu*KroneckerDelta(1,gO1
      ))*Sqr(g2);
...
std::complex<double> CLASSNAME::CpUAhconjHpmHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.25)*(vu*KroneckerDelta(0,gO2) + vd*KroneckerDelta(1,
      gO2))*Sqr(g2)*(Conj(ZP(gI2,1))*ZP(gI1,0) - Conj(ZP(gI2,0))*ZP(gI1,1));
...
std::complex<double> CLASSNAME::CpUAhbarChaChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0.,-0.7071067811865475)*g2*(KroneckerDelta(0,gO2)*UM(gI1,1)
      *UP(gI2,0) + KroneckerDelta(1,gO2)*UM(gI1,0)*UP(gI2,1));
...
std::complex<double> CLASSNAME::CpUAhbarChaChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0.,0.7071067811865475)*g2*(Conj(UM(gI2,1))*Conj(UP(gI1,0))*
      KroneckerDelta(0,gO1) + Conj(UM(gI2,0))*Conj(UP(gI1,1))*KroneckerDelta(1,gO1
      ));
...
std::complex<double> CLASSNAME::CpUAhbarFdFdPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1080 += tmp_1081;
   result += (Complex(0.,0.7071067811865475)*KroneckerDelta(0,gO2)) * tmp_1080;
...
std::complex<double> CLASSNAME::CpUAhbarFdFdPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1084 += tmp_1085;
   result += (Complex(0.,-0.7071067811865475)*KroneckerDelta(0,gO1)) * tmp_1084
      ;
...
std::complex<double> CLASSNAME::CpUAhbarFeFePR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1088 += tmp_1089;
   result += (Complex(0.,0.7071067811865475)*KroneckerDelta(0,gO2)) * tmp_1088;
...
std::complex<double> CLASSNAME::CpUAhbarFeFePL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1092 += tmp_1093;
   result += (Complex(0.,-0.7071067811865475)*KroneckerDelta(0,gO1)) * tmp_1092
      ;
...
std::complex<double> CLASSNAME::CpUAhbarFuFuPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1096 += tmp_1097;
   result += (Complex(0.,0.7071067811865475)*KroneckerDelta(1,gO2)) * tmp_1096;
...
std::complex<double> CLASSNAME::CpUAhbarFuFuPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1100 += tmp_1101;
   result += (Complex(0.,-0.7071067811865475)*KroneckerDelta(1,gO1)) * tmp_1100
      ;
...
std::complex<double> CLASSNAME::CpUAhChiChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,0.1)*(KroneckerDelta(0,gO2)*(ZN(gI1,2)*(3.872983346207417
      *g1*ZN(gI2,0) - 5*g2*ZN(gI2,1)) + (3.872983346207417*g1*ZN(gI1,0) - 5*g2*ZN(
      gI1,1))*ZN(gI2,2)) - KroneckerDelta(1,gO2)*(ZN(gI1,3)*(3.872983346207417*g1*
      ZN(gI2,0) - 5*g2*ZN(gI2,1)) + (3.872983346207417*g1*ZN(gI1,0) - 5*g2*ZN(gI1,
      1))*ZN(gI2,3)));
...
std::complex<double> CLASSNAME::CpUAhChiChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.1)*(Conj(ZN(gI1,2))*(3.872983346207417*g1*Conj(ZN(gI2,
      0)) - 5*g2*Conj(ZN(gI2,1)))*KroneckerDelta(0,gO1) - 5*g2*Conj(ZN(gI1,1))*
      Conj(ZN(gI2,2))*KroneckerDelta(0,gO1) - 3.872983346207417*g1*Conj(ZN(gI1,3))
      *Conj(ZN(gI2,0))*KroneckerDelta(1,gO1) + 5*g2*Conj(ZN(gI1,3))*Conj(ZN(gI2,1)
      )*KroneckerDelta(1,gO1) + 5*g2*Conj(ZN(gI1,1))*Conj(ZN(gI2,3))*
...
std::complex<double> CLASSNAME::CpUAhUAhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1105 += tmp_1106;
   tmp_1104 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1105;
   ...
   tmp_1107 += tmp_1108;
   tmp_1104 += (Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g2)) * tmp_1107;
   ...
   tmp_1109 += tmp_1110;
   tmp_1104 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g1)) * tmp_1109;
   ...
   tmp_1111 += tmp_1112;
   tmp_1104 += (Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g2)) * tmp_1111;
   ...
   tmp_1113 += tmp_1114;
   tmp_1104 += (Complex(0,0.1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_1113;
   ...
   tmp_1115 += tmp_1116;
   tmp_1104 += (Complex(0,-0.1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1115;
   ...
   tmp_1117 += tmp_1118;
   tmp_1104 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1117;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1130 += tmp_1131;
   tmp_1129 += (Complex(0,-0.15)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      Sqr(g1)) * tmp_1130;
   ...
   tmp_1132 += tmp_1133;
   tmp_1129 += (Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g2)) * tmp_1132;
   ...
   tmp_1134 += tmp_1135;
   tmp_1129 += (Complex(0,0.15)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1134;
   ...
   tmp_1136 += tmp_1137;
   tmp_1129 += (Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g2)) * tmp_1136;
   ...
   tmp_1138 += tmp_1139;
   tmp_1129 += (Complex(0,0.3)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_1138;
   ...
   tmp_1140 += tmp_1141;
   tmp_1129 += (Complex(0,-0.3)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1140;
   ...
   tmp_1142 += tmp_1143;
   tmp_1129 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1142;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1155 += tmp_1156;
   tmp_1154 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1155;
   ...
   tmp_1157 += tmp_1158;
   tmp_1154 += (Complex(0,-0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      Sqr(g2)) * tmp_1157;
   ...
   tmp_1159 += tmp_1160;
   tmp_1154 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g1)) * tmp_1159;
   ...
   tmp_1161 += tmp_1162;
   tmp_1154 += (Complex(0,0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g2)) * tmp_1161;
   ...
   tmp_1163 += tmp_1164;
   tmp_1154 += (Complex(0,-0.2)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1163;
   ...
   tmp_1165 += tmp_1166;
   tmp_1154 += (Complex(0,0.2)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_1165;
   ...
   tmp_1167 += tmp_1168;
   tmp_1154 += (Complex(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)) *
      tmp_1167;
...
std::complex<double> CLASSNAME::CpUAhVZhh(unsigned gO2, unsigned gI2) const
{
   ...
   result = Complex(0,-0.1)*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(
      ThetaW()))*(KroneckerDelta(0,gO2)*ZH(gI2,0) - KroneckerDelta(1,gO2)*ZH(gI2,1
      ));
...
std::complex<double> CLASSNAME::CpUAhconjVWmHpm(unsigned gO2, unsigned gI2) const
{
   ...
   result = Complex(0,-0.5)*g2*(Conj(ZP(gI2,0))*KroneckerDelta(0,gO2) + Conj(ZP
      (gI2,1))*KroneckerDelta(1,gO2));
...
std::complex<double> CLASSNAME::CpconjUHpmHpmAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.25)*(Conj(ZP(gI1,1))*KroneckerDelta(0,gO2) - Conj(ZP(
      gI1,0))*KroneckerDelta(1,gO2))*Sqr(g2)*(vu*ZA(gI2,0) + vd*ZA(gI2,1));
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1230 += Complex(0,-0.15)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      KroneckerDelta(gI1,gI2)*Sqr(g1);
   tmp_1230 += Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      KroneckerDelta(gI1,gI2)*Sqr(g2);
   tmp_1230 += Complex(0,0.15)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      KroneckerDelta(gI1,gI2)*Sqr(g1);
   tmp_1230 += Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      KroneckerDelta(gI1,gI2)*Sqr(g2);
   ...
   tmp_1231 += tmp_1232;
   tmp_1230 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1231;
   result += (Complex(0,-1)) * tmp_1230;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSvSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1248 += tmp_1249;
   tmp_1247 += (Complex(0.,-0.35355339059327373)*vd*KroneckerDelta(0,gO2)*Sqr(
      g2)) * tmp_1248;
   ...
   tmp_1250 += tmp_1251;
   tmp_1247 += (Complex(0.,-0.35355339059327373)*vu*KroneckerDelta(1,gO2)*Sqr(
      g2)) * tmp_1250;
   ...
   tmp_1252 += tmp_1253;
   tmp_1247 += (Complex(0,1)*KroneckerDelta(1,gO2)*Mu) * tmp_1252;
   ...
   tmp_1256 += tmp_1257;
   tmp_1247 += (Complex(0,1)*KroneckerDelta(0,gO2)) * tmp_1256;
   ...
   tmp_1260 += tmp_1261;
   tmp_1247 += (Complex(0.,0.7071067811865475)*vd*KroneckerDelta(0,gO2)) *
      tmp_1260;
   result += (Complex(0,-1)) * tmp_1247;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1267 += tmp_1268;
   tmp_1266 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1267;
   ...
   tmp_1269 += tmp_1270;
   tmp_1266 += (Complex(0,-0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      Sqr(g2)) * tmp_1269;
   ...
   tmp_1271 += tmp_1272;
   tmp_1266 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g1)) * tmp_1271;
   ...
   tmp_1273 += tmp_1274;
   tmp_1266 += (Complex(0,0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g2)) * tmp_1273;
   ...
   tmp_1275 += tmp_1276;
   tmp_1266 += (Complex(0,0.1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_1275;
   ...
   tmp_1277 += tmp_1278;
   tmp_1266 += (Complex(0,-0.1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1277;
   ...
   tmp_1279 += tmp_1280;
   tmp_1266 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1279;
   ...
   tmp_1285 += tmp_1286;
   tmp_1266 += (Complex(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)) *
      tmp_1285;
   result += (Complex(0,-1)) * tmp_1266;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1292 += tmp_1293;
   tmp_1291 += (Complex(0,-0.15)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      Sqr(g1)) * tmp_1292;
   ...
   tmp_1294 += tmp_1295;
   tmp_1291 += (Complex(0,-0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*
      Sqr(g2)) * tmp_1294;
   ...
   tmp_1296 += tmp_1297;
   tmp_1291 += (Complex(0,0.15)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1296;
   ...
   tmp_1298 += tmp_1299;
   tmp_1291 += (Complex(0,0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g2)) * tmp_1298;
   ...
   tmp_1300 += tmp_1301;
   tmp_1291 += (Complex(0,0.3)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr(
      g1)) * tmp_1300;
   ...
   tmp_1302 += tmp_1303;
   tmp_1291 += (Complex(0,-0.3)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr
      (g1)) * tmp_1302;
   ...
   tmp_1304 += tmp_1305;
   tmp_1291 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1304;
   result += (Complex(0,-1)) * tmp_1291;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1311 += tmp_1312;
   tmp_1310 += (Complex(0,0.05)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1311;
   ...
   tmp_1313 += tmp_1314;
   tmp_1310 += (Complex(0,0.25)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g2)) * tmp_1313;
   ...
   tmp_1315 += tmp_1316;
   tmp_1310 += (Complex(0,-0.05)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g1)) * tmp_1315;
   ...
   tmp_1317 += tmp_1318;
   tmp_1310 += (Complex(0,-0.25)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      Sqr(g2)) * tmp_1317;
   ...
   tmp_1319 += tmp_1320;
   tmp_1310 += (Complex(0,-0.2)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Sqr
      (g1)) * tmp_1319;
   ...
   tmp_1321 += tmp_1322;
   tmp_1310 += (Complex(0,0.2)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*Sqr(
      g1)) * tmp_1321;
   ...
   tmp_1323 += tmp_1324;
   tmp_1310 += (Complex(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)) *
      tmp_1323;
   ...
   tmp_1329 += tmp_1330;
   tmp_1310 += (Complex(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)) *
      tmp_1329;
   result += (Complex(0,-1)) * tmp_1310;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSuSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1336 += tmp_1337;
   tmp_1335 += (Complex(0.,-0.35355339059327373)*vd*KroneckerDelta(0,gO2)*Sqr(
      g2)) * tmp_1336;
   ...
   tmp_1338 += tmp_1339;
   tmp_1335 += (Complex(0.,-0.35355339059327373)*vu*KroneckerDelta(1,gO2)*Sqr(
      g2)) * tmp_1338;
   ...
   tmp_1340 += tmp_1341;
   tmp_1335 += (Complex(0,1)*Conj(Mu)*KroneckerDelta(0,gO2)) * tmp_1340;
   ...
   tmp_1344 += tmp_1345;
   tmp_1335 += (Complex(0,1)*KroneckerDelta(1,gO2)) * tmp_1344;
   ...
   tmp_1348 += tmp_1349;
   tmp_1335 += (Complex(0,1)*KroneckerDelta(1,gO2)*Mu) * tmp_1348;
   ...
   tmp_1352 += tmp_1353;
   tmp_1335 += (Complex(0,1)*KroneckerDelta(0,gO2)) * tmp_1352;
   ...
   tmp_1356 += tmp_1357;
   tmp_1335 += (Complex(0.,0.7071067811865475)*vu*KroneckerDelta(0,gO2)) *
      tmp_1356;
   ...
   tmp_1362 += tmp_1363;
   tmp_1335 += (Complex(0.,0.7071067811865475)*vd*KroneckerDelta(1,gO2)) *
      tmp_1362;
   ...
   tmp_1368 += tmp_1369;
   tmp_1335 += (Complex(0.,0.7071067811865475)*vd*KroneckerDelta(0,gO2)) *
      tmp_1368;
   ...
   tmp_1374 += tmp_1375;
   tmp_1335 += (Complex(0.,0.7071067811865475)*vu*KroneckerDelta(1,gO2)) *
      tmp_1374;
   result += (Complex(0,-1)) * tmp_1335;
...
std::complex<double> CLASSNAME::CpconjUHpmVWmAh(unsigned gO2, unsigned gI2) const
{
   ...
   result = Complex(0,-0.5)*g2*(KroneckerDelta(0,gO2)*ZA(gI2,0) +
...
std::complex<double> CLASSNAME::CpVZhhAh(unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.5)*(g2*Cos(ThetaW()) + 0.7745966692414834*g1*Sin(
      ThetaW()))*(ZA(gI2,0)*ZH(gI1,0) - ZA(gI2,1)*ZH(gI1,1));
...
std::complex<double> CLASSNAME::CpVZVZconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1381 += tmp_1382;
   tmp_1380 += (Complex(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) * tmp_1381;
   ...
   tmp_1383 += tmp_1384;
   tmp_1380 += (Complex(0.,0.2581988897471611)*g1*g2*Cos(ThetaW())*Sin(ThetaW()
      )) * tmp_1383;
   ...
   tmp_1385 += tmp_1386;
   tmp_1380 += (Complex(0,0.03333333333333333)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1385;
   ...
   tmp_1387 += tmp_1388;
   tmp_1380 += (Complex(0,0.13333333333333333)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1387;
   result += (Complex(0,-1)) * tmp_1380;
...
std::complex<double> CLASSNAME::CpVZVZconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1390 += tmp_1391;
   tmp_1389 += (Complex(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) * tmp_1390;
   ...
   tmp_1392 += tmp_1393;
   tmp_1389 += (Complex(0.,-0.7745966692414834)*g1*g2*Cos(ThetaW())*Sin(ThetaW(
      ))) * tmp_1392;
   ...
   tmp_1394 += tmp_1395;
   tmp_1389 += (Complex(0,0.3)*Sqr(g1)*Sqr(Sin(ThetaW()))) * tmp_1394;
   ...
   tmp_1396 += tmp_1397;
   tmp_1389 += (Complex(0,1.2)*Sqr(g1)*Sqr(Sin(ThetaW()))) * tmp_1396;
   result += (Complex(0,-1)) * tmp_1389;
...
std::complex<double> CLASSNAME::CpVZVZconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1399 += tmp_1400;
   tmp_1398 += (Complex(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) * tmp_1399;
   ...
   tmp_1401 += tmp_1402;
   tmp_1398 += (Complex(0.,-0.2581988897471611)*g1*g2*Cos(ThetaW())*Sin(ThetaW(
      ))) * tmp_1401;
   ...
   tmp_1403 += tmp_1404;
   tmp_1398 += (Complex(0,0.03333333333333333)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1403;
   ...
   tmp_1405 += tmp_1406;
   tmp_1398 += (Complex(0,0.5333333333333333)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1405;
   result += (Complex(0,-1)) * tmp_1398;
...
std::complex<double> CLASSNAME::CpconjVWmHpmAh(unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.5)*g2*(Conj(ZP(gI1,0))*ZA(gI2,0) + Conj(ZP(gI1,1))*ZA(
      gI2,1));
...
std::complex<double> CLASSNAME::CpUChiChiAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,-0.1)*(Conj(ZN(gI1,2))*(3.872983346207417*g1*
      KroneckerDelta(0,gO2) - 5*g2*KroneckerDelta(1,gO2))*ZA(gI2,0) - 5*g2*Conj(ZN
      (gI1,1))*KroneckerDelta(2,gO2)*ZA(gI2,0) - 3.872983346207417*g1*Conj(ZN(gI1,
...
std::complex<double> CLASSNAME::CpUChiChiAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0,0.1)*(KroneckerDelta(2,gO1)*ZA(gI2,0)*(3.872983346207417*
      g1*ZN(gI1,0) - 5*g2*ZN(gI1,1)) + KroneckerDelta(3,gO1)*ZA(gI2,1)*(
      -3.872983346207417*g1*ZN(gI1,0) + 5*g2*ZN(gI1,1)) + (3.872983346207417*g1*
      KroneckerDelta(0,gO1) - 5*g2*KroneckerDelta(1,gO1))*(ZA(gI2,0)*ZN(gI1,2) -
      ZA(gI2,1)*ZN(gI1,3)));
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1435 += tmp_1436;
   tmp_1434 += (Complex(0.,-0.18257418583505536)*g1*KroneckerDelta(0,gO2)) *
      tmp_1435;
   ...
   tmp_1437 += tmp_1438;
   tmp_1434 += (Complex(0.,0.7071067811865475)*g2*KroneckerDelta(1,gO2)) *
      tmp_1437;
   ...
   tmp_1439 += tmp_1440;
   tmp_1434 += (Complex(0,-1)*KroneckerDelta(2,gO2)) * tmp_1439;
   result += (Complex(0,-1)) * tmp_1434;
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1444 += tmp_1445;
   tmp_1443 += (Complex(0.,-0.3651483716701107)*g1*KroneckerDelta(0,gO1)) *
      tmp_1444;
   ...
   tmp_1446 += tmp_1447;
   tmp_1443 += (Complex(0,-1)*KroneckerDelta(2,gO1)) * tmp_1446;
   result += (Complex(0,-1)) * tmp_1443;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1451 += tmp_1452;
   tmp_1450 += (Complex(0.,0.5477225575051661)*g1*KroneckerDelta(0,gO2)) *
      tmp_1451;
   ...
   tmp_1453 += tmp_1454;
   tmp_1450 += (Complex(0.,0.7071067811865475)*g2*KroneckerDelta(1,gO2)) *
      tmp_1453;
   ...
   tmp_1455 += tmp_1456;
   tmp_1450 += (Complex(0,-1)*KroneckerDelta(2,gO2)) * tmp_1455;
   result += (Complex(0,-1)) * tmp_1450;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1460 += tmp_1461;
   tmp_1459 += (Complex(0.,-1.0954451150103321)*g1*KroneckerDelta(0,gO1)) *
      tmp_1460;
   ...
   tmp_1462 += tmp_1463;
   tmp_1459 += (Complex(0,-1)*KroneckerDelta(2,gO1)) * tmp_1462;
   result += (Complex(0,-1)) * tmp_1459;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1467 += tmp_1468;
   tmp_1466 += (Complex(0.,-0.18257418583505536)*g1*KroneckerDelta(0,gO2)) *
      tmp_1467;
   ...
   tmp_1469 += tmp_1470;
   tmp_1466 += (Complex(0.,-0.7071067811865475)*g2*KroneckerDelta(1,gO2)) *
      tmp_1469;
   ...
   tmp_1471 += tmp_1472;
   tmp_1466 += (Complex(0,-1)*KroneckerDelta(3,gO2)) * tmp_1471;
   result += (Complex(0,-1)) * tmp_1466;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1476 += tmp_1477;
   tmp_1475 += (Complex(0.,0.7302967433402214)*g1*KroneckerDelta(0,gO1)) *
      tmp_1476;
   ...
   tmp_1478 += tmp_1479;
   tmp_1475 += (Complex(0,-1)*KroneckerDelta(3,gO1)) * tmp_1478;
   result += (Complex(0,-1)) * tmp_1475;
...
std::complex<double> CLASSNAME::CpbarUChaChaAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0.,0.7071067811865475)*g2*(Conj(UM(gI1,1))*KroneckerDelta(0
      ,gO2)*ZA(gI2,0) + Conj(UM(gI1,0))*KroneckerDelta(1,gO2)*ZA(gI2,1));
...
std::complex<double> CLASSNAME::CpbarUChaChaAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   result = Complex(0.,-0.7071067811865475)*g2*(KroneckerDelta(1,gO1)*UP(gI1,0)
      *ZA(gI2,0) + KroneckerDelta(0,gO1)*UP(gI1,1)*ZA(gI2,1));
...
std::complex<double> CLASSNAME::CpbarUChabarFuSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1493 += tmp_1494;
   tmp_1492 += (Complex(0,-1)*g2*KroneckerDelta(0,gO1)) * tmp_1493;
   ...
   tmp_1495 += tmp_1496;
   tmp_1492 += (Complex(0,1)*KroneckerDelta(1,gO1)) * tmp_1495;
   result += (Complex(0,-1)) * tmp_1492;
...
std::complex<double> CLASSNAME::CpbarUChaconjSuFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1502 += tmp_1503;
   tmp_1501 += (Complex(0,-1)*g2*KroneckerDelta(0,gO2)) * tmp_1502;
   ...
   tmp_1504 += tmp_1505;
   tmp_1501 += (Complex(0,1)*KroneckerDelta(1,gO2)) * tmp_1504;
   result += (Complex(0,-1)) * tmp_1501;
...
std::complex<double> CLASSNAME::CpbarUFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      tmp_1516 += tmp_1517;
      result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_1516;
   }
...
std::complex<double> CLASSNAME::CpbarUFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      tmp_1518 += tmp_1519;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_1518;
   }
...
std::complex<double> CLASSNAME::CpbarUFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      tmp_1534 += tmp_1535;
      result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_1534;
   }
...
std::complex<double> CLASSNAME::CpbarUFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      tmp_1536 += tmp_1537;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_1536;
   }
...
std::complex<double> CLASSNAME::CpbarUFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      tmp_1558 += tmp_1559;
      result += (Complex(0.,-0.7071067811865475)*ZA(gI2,1)) * tmp_1558;
   }
...
std::complex<double> CLASSNAME::CpbarUFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      tmp_1560 += tmp_1561;
      result += (Complex(0.,0.7071067811865475)*ZA(gI2,1)) * tmp_1560;
   }
...
std::complex<double> CLASSNAME::CpGluVGGluPR() const
{
   ...
   result = Complex(0,-1)*g3*AbsSqr(PhaseGlu);
...
std::complex<double> CLASSNAME::CpbarFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1584 += tmp_1585;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_1584;
...
std::complex<double> CLASSNAME::CpbarFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1588 += tmp_1589;
   result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_1588;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1626 += tmp_1627;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,0)) * tmp_1626;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1630 += tmp_1631;
   result += (Complex(0.,0.7071067811865475)*ZA(gI2,0)) * tmp_1630;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1690 += tmp_1691;
   result += (Complex(0.,-0.7071067811865475)*ZA(gI2,1)) * tmp_1690;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1694 += tmp_1695;
   result += (Complex(0.,0.7071067811865475)*ZA(gI2,1)) * tmp_1694;
...
void CLASSNAME::calculate_MVG_pole_1loop()
{
   // diagonalization with medium precision
   PHYSICAL(MVG) = 0.;
}

void CLASSNAME::calculate_MGlu_pole_1loop()
{
   // diagonalization with medium precision
   const double p = MGlu;
...
void CLASSNAME::calculate_MFv_pole_1loop()
{
   // diagonalization with medium precision
   PHYSICAL(MFv).setConstant(0.);
}

void CLASSNAME::calculate_MVP_pole_1loop()
{
   // diagonalization with medium precision
   PHYSICAL(MVP) = 0.;
}

void CLASSNAME::calculate_MVZ_pole_1loop()
{
...
void CLASSNAME::calculate_MSd_pole_1loop()
{
...
void CLASSNAME::calculate_MSv_pole_1loop()
{
...
void CLASSNAME::calculate_MSu_pole_1loop()
{
...
void CLASSNAME::calculate_MSe_pole_1loop()
{
...
void CLASSNAME::calculate_Mhh_pole_1loop()
{
...
void CLASSNAME::calculate_MAh_pole_1loop()
{
...
void CLASSNAME::calculate_MHpm_pole_1loop()
{
...
void CLASSNAME::calculate_MChi_pole_1loop()
{
   // diagonalization with medium precision
...
void CLASSNAME::calculate_MCha_pole_1loop()
{
   // diagonalization with medium precision
...
void CLASSNAME::calculate_MFe_pole_1loop()
{
   // diagonalization with medium precision
...
void CLASSNAME::calculate_MFd_pole_1loop()
{
   // diagonalization with medium precision
   Eigen::Matrix<double,3,3> self_energy_1;
   Eigen::Matrix<double,3,3> self_energy_PL;
...
void CLASSNAME::calculate_MFu_pole_1loop()
{
   // diagonalization with medium precision
   Eigen::Matrix<double,3,3> self_energy_1;
   Eigen::Matrix<double,3,3> self_energy_PL;
...
void CLASSNAME::calculate_MVWm_pole_1loop()
{
...
double CLASSNAME::calculate_MFu_DRbar_1loop(double m_pole, int idx) const
{
...
double CLASSNAME::calculate_MFd_DRbar_1loop(double m_sm_msbar, int idx)
   const
{
   ...
   const double m_sm_drbar = m_sm_msbar * (1 - 0.00020496318737651018*
      Power(g3,4) + 0.0011433814126305477*Sqr(g1) + 0.0023747152416172916*Sqr(
...
double CLASSNAME::calculate_MFe_DRbar_1loop(double m_sm_msbar, int idx)
   const
{
   const double p = m_sm_msbar;
   ...
   const double self_energy_PR = Re(self_energy_Fe_PR_heavy_rotated(p,
      idx, idx));
   const double m_sm_drbar = m_sm_msbar * (1 - 0.0023747152416172916*(Sqr
      (g1) - Sqr(g2)));
...
double CLASSNAME::calculate_MFv_DRbar_1loop(double, int) const
{
   return 0.0;
}

double CLASSNAME::calculate_MVP_DRbar_1loop(double) const
{
   return 0.0;
}

double CLASSNAME::calculate_MVZ_DRbar_1loop(double m_pole) const
{
   const double p = m_pole;
   const double self_energy = Re(self_energy_VZ(p));
...
double CLASSNAME::calculate_MVWm_DRbar_1loop(double m_pole) const
{
   const double p = m_pole;
   const double self_energy = Re(self_energy_VWm(p));
   const double mass_sqr = Sqr(m_pole) + self_energy;
...
{
   return ArcSin(g1/Sqrt(Sqr(g1) + 1.6666666666666667*Sqr(g2)));
}
