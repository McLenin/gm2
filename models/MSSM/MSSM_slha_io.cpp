...
void MSSM_slha_io::fill(MSSM_input_parameters& input) const
{
   ...
   SLHA_io::Tuple_processor minpar_processor
      = std::bind(&MSSM_slha_io::fill_minpar_tuple, std::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = std::bind(&MSSM_slha_io::fill_extpar_tuple, std::ref(input), _1, _2);
...
void MSSM_slha_io::fill(Program_options& options) const
{
   using namespace std::placeholders;
   SLHA_io::Tuple_processor flexiblesusy_processor
      = std::bind(&MSSM_slha_io::fill_flexiblesusy_tuple, std::ref(options), _1, _2);
...
void MSSM_slha_io::fill_flexiblesusy_tuple(Program_options& options,
                                                  int key, double value)
{
