...
#ifndef MSSM_LATTICE_SUSY_SCALE_CONSTRAINT_H
#define MSSM_LATTICE_SUSY_SCALE_CONSTRAINT_H
...
template<>
class MSSM_susy_scale_constraint<Lattice> : public Constraint<Lattice> {
public:
